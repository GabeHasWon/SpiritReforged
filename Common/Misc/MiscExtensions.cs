...
internal static class MiscExtensions
{
	...
	/// <summary> Ends and restarts the spriteBatch with default vanilla parameters. </summary>
	...
	/// <summary> Begins the spriteBatch with default vanilla parameters. </summary>
