...
public abstract class SwungProjectile : ModProjectile
{
	...
	public Vector2 GetEndPosition(int add = 0) => Projectile.Center + new Vector2(ScaledReach + add, 0).RotatedBy(GetRotation(out _, out Player.CompositeArmStretchAmount _));
