...
{
    public override BuffSettings Settings => new(1f * VanillaScaling, (int)(800 * VanillaMaximum), true, Category.Bleeding);

    public override void Load() => BuffHandler.Register(this, BuffID.Bleeding, BuffID.BloodButcherer);
