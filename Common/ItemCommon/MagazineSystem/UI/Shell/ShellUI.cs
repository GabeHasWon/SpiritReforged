...
namespace SpiritReforged.Common.ItemCommon.MagazineSystem.UI.Shell;
public class ShellUI
{
	public static readonly Asset<Texture2D> ShellTexture = DrawHelpers.RequestLocal<ShellUI>("ShellUI", false);
	public static readonly Asset<Texture2D> ShellOutline = DrawHelpers.RequestLocal<ShellUI>("ShellUI_Outline", false);
	...
	public class ShellUIAmmo(Vector2 position, Vector2 velocity, int timeLeft, bool empowered = false) : MagazineUIAmmo(position, velocity, timeLeft, empowered)
	{
		...
		public override void Draw(SpriteBatch sb)
		{
			...
			Texture2D outlineTexture = ShellOutline.Value;
