...
public class ChestLoot : ModSystem
{
	public override void PostWorldGen()
	{
		...
		AddToVanillaChest(new ChestInfo([ModContent.ItemType<ZiplineGun>(), ModContent.ItemType<ExplorerTreadsItem>(), ModContent.ItemType<FingerGun>()],  1, 0.33f), (int)VanillaChestID.Gold, 1);
