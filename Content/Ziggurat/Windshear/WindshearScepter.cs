...
public class WindshearScepter : ModItem
{
	...
	public class WindshearScepterSwing : SwungProjectile
	{
		...
		public override float GetRotation(out float armRotation)
		{
			...
			{
				Vector2 endPosition = Projectile.Center + new Vector2(GetConfig<BasicConfiguration>().Reach, -GetConfig<BasicConfiguration>().Reach).RotatedBy(Projectile.rotation);
		...
		public override bool PreDraw(ref Color lightColor)
		{
			...
			DrawSmear(Projectile.GetAlpha(Color.Goldenrod.Additive(100)) * 0.3f * opacity, Projectile.rotation - MathHelper.PiOver4, (int)(Progress * 8f), GetConfig<BasicConfiguration>().Reach + 38, 0.5f, effects);
			DrawSmear(Projectile.GetAlpha(Color.White.Additive(100)) * 0.3f * opacity, Projectile.rotation - MathHelper.PiOver4, (int)(Progress * 8f), GetConfig<BasicConfiguration>().Reach + 38, 0.4f, effects);
