...
public class ZigguratBiome : ModBiome
{
	...
	public static readonly HashSet<int> WallTypes = [RedSandstoneBrickWall.UnsafeType, RedSandstoneBrickCrackedWall.UnsafeType, ModContent.WallType<RedSandstoneBrickForegroundWall>(), CarvedLapisWall.UnsafeType, PaleHiveWall.UnsafeType, ModContent.WallType<SandyZigguratWall>()];
	///// <summary> A collection of tiles associated with the natural biome. </summary>
