...
public class RubyBonsaiItem : SakuraBonsaiItem
{
	...
	public override void SetStaticDefaults() => NPCShopHelper.AddEntry(new NPCShopHelper.ConditionalEntry((shop) 
		=> shop.NpcType == NPCID.Dryad, new NPCShop.Entry(Type, Condition.PlayerCarriesItem(ItemID.Ruby))));
}
...
public class DiamondBonsaiItem : SakuraBonsaiItem
{
	...
	public override void SetStaticDefaults() => NPCShopHelper.AddEntry(new NPCShopHelper.ConditionalEntry((shop) 
		=> shop.NpcType == NPCID.Dryad, new NPCShop.Entry(Type, Condition.PlayerCarriesItem(ItemID.Diamond))));
}
...
public class EmeraldBonsaiItem : SakuraBonsaiItem
{
	...
	public override void SetStaticDefaults() => NPCShopHelper.AddEntry(new NPCShopHelper.ConditionalEntry((shop) 
		=> shop.NpcType == NPCID.Dryad, new NPCShop.Entry(Type, Condition.PlayerCarriesItem(ItemID.Emerald))));
}
...
public class SapphireBonsaiItem : SakuraBonsaiItem
{
	...
	public override void SetStaticDefaults() => NPCShopHelper.AddEntry(new NPCShopHelper.ConditionalEntry((shop) 
		=> shop.NpcType == NPCID.Dryad, new NPCShop.Entry(Type, Condition.PlayerCarriesItem(ItemID.Sapphire))));
}
...
public class TopazBonsaiItem : SakuraBonsaiItem
{
	...
	public override void SetStaticDefaults() => NPCShopHelper.AddEntry(new NPCShopHelper.ConditionalEntry((shop) 
		=> shop.NpcType == NPCID.Dryad, new NPCShop.Entry(Type, Condition.PlayerCarriesItem(ItemID.Topaz))));
}
...
public class AmethystBonsaiItem : SakuraBonsaiItem
{
	...
	public override void SetStaticDefaults() => NPCShopHelper.AddEntry(new NPCShopHelper.ConditionalEntry((shop) 
		=> shop.NpcType == NPCID.Dryad, new NPCShop.Entry(Type, Condition.PlayerCarriesItem(ItemID.Amethyst))));
}