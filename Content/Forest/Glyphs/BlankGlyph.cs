...
public class GlyphGlobalItem : GlobalItem
{
	...
	public override bool CanRightClick(Item item) => Main.LocalPlayer.HeldItem.ModItem is GlyphItem glyphItem && glyphItem.CanBeApplied(item);
...
public abstract class GlyphItem : ModItem
{
	...
	public static readonly SoundStyle EnchantSound = new("SpiritReforged/SFX/Item/GlyphAttach");
	...
	public virtual void OnApply(Item item, Player player)
	{
		...
		SoundEngine.PlaySound(EnchantSound, player.Center);
	}
