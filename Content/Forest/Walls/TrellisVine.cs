...
public class CustomTrellisVine(int customId, string internalName, string assetPath) : ModTile
{
	public const int StyleRange = 7;
	...
	public readonly int Id = customId;
	public readonly string TexturePath = assetPath;
