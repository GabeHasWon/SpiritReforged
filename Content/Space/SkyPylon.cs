...
public class SkyPylon : PylonTile
{
	...
	public override bool ValidTeleportCheck_BiomeRequirements(TeleportPylonInfo pylonInfo, SceneMetrics sceneData) => pylonInfo.PositionInTiles.Y <= Main.worldSurface * 0.36f;
