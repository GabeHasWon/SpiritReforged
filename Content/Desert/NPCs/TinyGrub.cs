...
public class TinyGrub : ModNPC
{
	...
	public override float SpawnChance(NPCSpawnInfo spawnInfo)
	{
		...
		return ((type == ModContent.TileType<PaleHive>() || type == ModContent.TileType<InfectedHive>()) && Main.tile[spawnInfo.SpawnTileX, spawnInfo.SpawnTileY - 1].WallType == PaleHiveWall.UnsafeType) ? 0.2f : 0;
	}
}