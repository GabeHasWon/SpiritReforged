...
public class Flamingo : ModNPC
{
	...
	{
		if (!spawnInfo.EventSafe() || spawnInfo.Water || !spawnInfo.Player.InModBiome<SaltBiome>() || !SceneTileCounter.GetSurvey<SaltBiome>().tileTypes.Contains(spawnInfo.SpawnTileType))
			return 0;
