...
public class SaltFlatsCampfire : ModTile, IAutoloadTileItem
{
	...
	public void AddItemRecipes(ModItem item) => item.CreateRecipe().AddRecipeGroup(RecipeGroupID.Wood, 10).AddIngredient(ModContent.ItemType<SaltTorchItem>(), 5).Register();
	...
	public override void ModifyLight(int i, int j, ref float r, ref float g, ref float b)
	{
		if (OnFire(i, j))
		{
			...
			(r, g, b) = (0.75f + pulse, 0.6f + pulse, 1f + pulse);
		}
	}
