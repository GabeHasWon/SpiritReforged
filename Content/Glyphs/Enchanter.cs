...
public class Enchanter : ModNPC
{
	...
	public override void AddShops() => new NPCShop(Type)
		.Add<EnchantedStamp>()
		.Add(ItemID.MagicMirror, Condition.DownedBrainOfCthulhu)
		.Add(ItemID.IceMirror, Condition.DownedBrainOfCthulhu, Condition.InSnow)
		.Add(ItemID.MagicMirror, Condition.DownedEaterOfWorlds)
		.Add(ItemID.IceMirror, Condition.DownedEaterOfWorlds, Condition.InSnow)
		.Add<Flarepowder>()
