	...
	public override void IdleMovement(Player player)
	{
		...
		switch (AiState)
		{
			case STATE_HOVERTORESTSPOT:
				...
				if (Projectile.Distance(targetCenter) < 10 && Projectile.Center.Y < targetCenter.Y && canstartrest && !CollisionChecks.CheckSolidTilesAndPlatforms(new Rectangle(startX, tilepos.Y, 1, 1)) && AiTimer > 30)
				{
					AiTimer = 0;
