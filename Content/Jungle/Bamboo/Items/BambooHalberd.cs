...
{
	public sealed class BambooHalberdProj : ModProjectile
	{
		...
		public override bool PreDraw(ref Color lightColor)
		{
			...
			Vector2 origin = new(effects == SpriteEffects.FlipHorizontally ? Projectile.width / 2 : texture.Width - Projectile.width / 2, texture.Height / 2);
